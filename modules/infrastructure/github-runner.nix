...

{
  ...
  # SSH known_hosts for github-runner (github.com, shannon, feynman, localhost/einstein)
  environment.etc."ssh/ssh_known_hosts".text = ''
    ...
    localhost ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJbSfyESdV7Wr9zSHDbjLt2+/Fql3uEOEdxjhHvDDdmc
    127.0.0.1 ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIJbSfyESdV7Wr9zSHDbjLt2+/Fql3uEOEdxjhHvDDdmc
